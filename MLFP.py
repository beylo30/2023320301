...
get_ipython().system('git config --global user.name "beylo30"')
get_ipython().system('git config --global user.email "nabil.nours30@gmail.com"')


# In[5]:


get_ipython().system('git clone https://github.com/beylo30/2023320301')

get_ipython().run_line_magic('cd', '2023320301')


# In[6]:


get_ipython().run_line_magic('cd', '/root/2023320301')
...
get_ipython().system('find /content/drive/MyDrive -maxdepth 5 -name "*.ipynb"')
...
get_ipython().system('cp "/content/drive/MyDrive/MLFP.ipynb" .')
...
get_ipython().system('git commit -m "Add files"')
